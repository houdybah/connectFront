...
import {TypeProduitRubriqueService} from "../../../services/type-produit-rubrique.service";
import Swal from "sweetalert2";

@Component({
  selector: 'app-mensualisation-with-ventilisation',
  templateUrl: './mensualisation-with-ventilisation.component.html',
  styleUrl: './mensualisation-with-ventilisation.component.scss'
})
export class MensualisationWithVentilisationComponent {
